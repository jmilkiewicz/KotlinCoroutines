...
suspend fun performanceTest(): Unit = coroutineScope {
    ...
    val repository = CompanyDetailsRepositoryDeferred(client, Dispatchers.IO)
...
class CompanyDetailsRepositoryTest {
    ...
    fun `detailsFor should fetch details from client`() = runTest {
        ...
        val repository = CompanyDetailsRepositoryDeferred(client, coroutineContext[CoroutineDispatcher]!!)
